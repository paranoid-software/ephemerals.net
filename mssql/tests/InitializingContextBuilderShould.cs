    ...
    public class InitializingContextBuilderShould
    {
        ...
        public void ThrowExceptionWhenDataSourceIsNotLocal()
        {
            var exception = Assert.Throws<Exception>(() =>
                new EphemeralMsSqlDbContextBuilder().Build("Data Source=192.168.1.1,31433;Persist Security Info=False;Max Pool Size=1024;"));
        ...
        {
            var exception = Assert.Throws<Exception>(() =>
                new EphemeralMsSqlDbContextBuilder().Build("Data Source=localhost,31433;Persist Security Info=False;Max Pool Size=1024;Initial Catalog=my_database;"));
